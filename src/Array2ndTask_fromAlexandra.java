...
public class Array2ndTask_fromAlexandra {
    public static void main(String[] args) {
        ...
        int secondmaxNum = lowestNum;
        for (int i = 0; i < myArray2.length; i++) {
            if (myArray2[i] > secondmaxNum && myArray2[i] < maxNum)
                secondmaxNum = myArray2[i];
        }
        System.out.println("The second highest number is " + secondmaxNum);
